...
/**
 * Created by 蒲家旺 on 2017/4/12.
 */
public class Carousel3DView extends ImageView{
    /**
     * 旋转角度的基准值
     */
    ...
    public Carousel3DView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mCamera = new Camera();
        mMaxtrix = new Matrix();
    }
    ...
    public void initImageViewBitmap() {
        ...
        mLayoutWidth = Carousel3DSwitchView.mWidth;
        mWidth = getWidth() + Carousel3DSwitchView.IMAGE_PADDING * 2;
    }
        ...
        switch (mIndex) {
            ...
            case 1:
                if (mScrollX > 0) {
                    ...
                    if (mScrollX < -mWidth) {
                        mDx = -Carousel3DSwitchView.IMAGE_PADDING * 2;
