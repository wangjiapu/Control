...
public class Carousel3DSwitchView extends ViewGroup {
    ...
    private OnImageonclickLister mclickListenter;
    /**
     * 记录当前的触摸状态
     */
    ...
    public Carousel3DSwitchView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        if (changed || forceToRelayout) {
            ...
            if (mCurrentImage >= 0 && mCurrentImage < mCount) {
                ...
                for (int i = 0; i < items.length; i++) {
                    Carousel3DView childView = (Carousel3DView) getChildAt(items[i]);
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (shouldScrollToNext(velocityX)) {
                        ...
                        if(mclickListenter!=null){
                            mclickListenter.onImageOnclick(mCurrentImage);
                        }
    ...
    public void setOnImageOnclickLister(OnImageonclickLister lister){
        mclickListenter=lister;
    }
    /**
    ...
    public void clear() {
        for (int i = 0; i < mCount; i++) {
            Carousel3DView childView = (Carousel3DView) getChildAt(i);
    ...
    private void refreshImageShowing() {
        for (int i = 0; i < mItems.length; i++) {
            Carousel3DView childView = (Carousel3DView) getChildAt(mItems[i]);
     ...
     * 图片点击监听器
     */
    public interface OnImageonclickLister{
        void onImageOnclick(int currentImage);
    }
}
